-- MartPoint New Arrival Products Migration (v4.0.9)
-- Adds is_new_arrival flag to db_items for manual storefront "New Arrival" control.
-- Mirrors the is_featured flag. Idempotent. Safe to re-run.
-- --------------------------------------------------------
...
INSERT IGNORE INTO `db_schema_migrations` (`version`, `applied_at`) VALUES ('4.0.9-new-arrival', NOW());
