...
- **[high]** Stress test database selection failed
  - Root cause: Access denied for user 'martpoint'@'localhost' to database 'martpoint_stress_20260704_124545'
...
- **high** Stress test database selection failed — Access denied for user 'martpoint'@'localhost' to database 'martpoint_stress_20260704_124545'
