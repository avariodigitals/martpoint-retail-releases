...
- **[high]** (Stress) Stress test schema load failed in db_install_extensions.sql (``)
...
- `stress_ac_transactions`: 0.22 MB (rows: unknown)
- `db_customer_memberships`: 0.11 MB (rows: unknown)
- `db_stocktransferitems`: 0.11 MB (rows: 1)
- `stress_db_stocktransferitems`: 0.11 MB (rows: 1)
...
- `stress_ac_accounts`: 0.09 MB (rows: unknown)
- `stress_db_salespayments`: 0.09 MB (rows: 59)
...
- `stress_db_permissions`: 0.08 MB (rows: 528)
- `stress_db_sales`: 0.08 MB (rows: 58)
- `stress_db_stockadjustmentitems`: 0.08 MB (rows: 3)
- `stress_db_stocktransfer`: 0.08 MB (rows: 1)
...
- `stress_ac_moneydeposits`: 0.06 MB (rows: unknown)
- `stress_ac_moneytransfer`: 0.06 MB (rows: unknown)
- `stress_db_customer_coupons`: 0.06 MB (rows: unknown)
- `stress_db_hold`: 0.06 MB (rows: unknown)
- `stress_db_holditems`: 0.06 MB (rows: unknown)
- `stress_db_purchaseitemsreturn`: 0.06 MB (rows: unknown)
- `stress_db_purchasepayments`: 0.06 MB (rows: 2)
- `stress_db_purchasepaymentsreturn`: 0.06 MB (rows: unknown)
- `stress_db_quotation`: 0.06 MB (rows: unknown)
- `stress_db_salespaymentsreturn`: 0.06 MB (rows: unknown)
- `stress_db_salesreturn`: 0.06 MB (rows: unknown)
- `stress_db_timezone`: 0.06 MB (rows: 548)
- `stress_db_warehouseitems`: 0.06 MB (rows: 4)
...
- `stress_db_custadvance`: 0.05 MB (rows: unknown)
- `stress_db_customer_payments`: 0.05 MB (rows: unknown)
- `stress_db_expense`: 0.05 MB (rows: unknown)
- `stress_db_purchase`: 0.05 MB (rows: 2)
- `stress_db_purchaseitems`: 0.05 MB (rows: 2)
- `stress_db_purchasereturn`: 0.05 MB (rows: unknown)
- `stress_db_quotationitems`: 0.05 MB (rows: unknown)
- `stress_db_salesitems`: 0.05 MB (rows: 64)
- `stress_db_salesitemsreturn`: 0.05 MB (rows: unknown)
- `stress_db_shippingaddress`: 0.05 MB (rows: 2)
- `stress_db_supplier_payments`: 0.05 MB (rows: unknown)
- `stress_db_userswarehouses`: 0.05 MB (rows: 1)
...
- `stress_ci_sessions`: 0.03 MB (rows: 40)
- `stress_db_bankdetails`: 0.03 MB (rows: 1)
- `stress_db_brands`: 0.03 MB (rows: unknown)
- `stress_db_category`: 0.03 MB (rows: 1)
- `stress_db_coupons`: 0.03 MB (rows: unknown)
- `stress_db_customers`: 0.03 MB (rows: 2)
- `stress_db_emailtemplates`: 0.03 MB (rows: 2)
- `stress_db_expense_category`: 0.03 MB (rows: unknown)
- `stress_db_instamojo`: 0.03 MB (rows: 1)
- `stress_db_items`: 0.03 MB (rows: 3)
- `stress_db_package`: 0.03 MB (rows: 3)
- `stress_db_paymenttypes`: 0.03 MB (rows: 1)
- `stress_db_paypal`: 0.03 MB (rows: 1)
- `stress_db_roles`: 0.03 MB (rows: 3)
- `stress_db_smsapi`: 0.03 MB (rows: 6)
- `stress_db_smstemplates`: 0.03 MB (rows: 4)
- `stress_db_states`: 0.03 MB (rows: 32)
- `stress_db_stockadjustment`: 0.03 MB (rows: 3)
- `stress_db_stripe`: 0.03 MB (rows: unknown)
- `stress_db_suppliers`: 0.03 MB (rows: 1)
- `stress_db_tax`: 0.03 MB (rows: 1)
- `stress_db_twilio`: 0.03 MB (rows: 2)
- `stress_db_units`: 0.03 MB (rows: 2)
- `stress_db_users`: 0.03 MB (rows: 3)
- `stress_db_variants`: 0.03 MB (rows: unknown)
- `stress_db_warehouse`: 0.03 MB (rows: 3)
...
- `stress_db_cobpayments`: 0.02 MB (rows: unknown)
- `stress_db_company`: 0.02 MB (rows: 1)
- `stress_db_country`: 0.02 MB (rows: 206)
- `stress_db_currency`: 0.02 MB (rows: 55)
- `stress_db_instamojopayments`: 0.02 MB (rows: unknown)
- `stress_db_languages`: 0.02 MB (rows: 6)
- `stress_db_paypalpaylog`: 0.02 MB (rows: unknown)
- `stress_db_sitesettings`: 0.02 MB (rows: 1)
- `stress_db_sobpayments`: 0.02 MB (rows: unknown)
- `stress_db_stockentry`: 0.02 MB (rows: unknown)
- `stress_db_store`: 0.02 MB (rows: 2)
- `stress_db_stripepayments`: 0.02 MB (rows: unknown)
- `stress_db_subscription`: 0.02 MB (rows: 6)
- `stress_temp_holdinvoice`: 0.02 MB (rows: unknown)
