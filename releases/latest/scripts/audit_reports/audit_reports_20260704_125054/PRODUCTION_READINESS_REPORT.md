...
- **[low]** Date column nullable without default (`db_users`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_ac_accounts`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_ac_moneydeposits`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_ac_moneytransfer`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_ac_transactions`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Table not using utf8mb4 collation (`stress_db_bankdetails`)
  - Root cause: Mixed collation can cause join errors
  - Fix: Consider converting to utf8mb4_unicode_ci
- **[low]** Date column nullable without default (`stress_db_cobpayments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_cobpayments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_coupons`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_custadvance`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_custadvance`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_customer_coupons`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_customer_payments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_customer_payments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_customers`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_expense`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_hold`.sales_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_items`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_package`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchase`.purchase_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchase`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchasepayments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchasepayments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchasepaymentsreturn`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchasepaymentsreturn`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_purchasereturn`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_quotation`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_sales`.sales_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_sales`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_salespayments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_salespayments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_salespaymentsreturn`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_salespaymentsreturn`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_salesreturn`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_sobpayments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_sobpayments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_stockadjustment`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_stocktransfer`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_store`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_subscription`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_supplier_payments`.payment_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_supplier_payments`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_suppliers`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_db_users`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
- **[low]** Date column nullable without default (`stress_temp_holdinvoice`.created_date)
  - Root cause: Could allow NULL where business expects a date
  - Fix: Consider NOT NULL DEFAULT CURRENT_TIMESTAMP or proper nullable handling
...
- **[low]** Table exceeds 50 columns (`db_storefront_settings`)
  - Root cause: Wide tables reduce performance and maintainability
  - Fix: Normalize rarely used columns into related tables
- **[low]** Table exceeds 50 columns (`stress_db_customers`)
  - Root cause: Wide tables reduce performance and maintainability
  - Fix: Normalize rarely used columns into related tables
- **[low]** Table exceeds 50 columns (`stress_db_store`)
  - Root cause: Wide tables reduce performance and maintainability
  - Fix: Normalize rarely used columns into related tables
...
- **[high]** Stress test schema load failed in db_install_extensions.sql
  - Root cause: Table 'martpoint.stress_db_subscription_plans' doesn't exist
  - Fix: Fix installer schema for large scale
...
- **high** Stress test schema load failed in db_install_extensions.sql — Table 'martpoint.stress_db_subscription_plans' doesn't exist
