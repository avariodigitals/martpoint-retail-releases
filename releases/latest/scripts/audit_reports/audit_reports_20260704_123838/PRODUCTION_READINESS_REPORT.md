...
- **[high]** Upgrade migration failed
  - Root cause: Duplicate column name 'received_qty'
...
- **[high]** Stress test schema load failed
...
- **high** Upgrade migration failed — Duplicate column name 'received_qty'
- **high** Upgrade migration failed — Duplicate column name 'received_qty'
- **high** Missing primary key on table — Table created without PRIMARY KEY
- **high** Missing primary key on table — Table created without PRIMARY KEY
- **high** Missing primary key on table — Table created without PRIMARY KEY
...
- **high** Stress test schema load failed — Table 'ac_accounts' already exists
