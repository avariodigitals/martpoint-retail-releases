...
- **[high]** Stress test schema load failed in db_install_extensions.sql
  - Root cause: Table 'martpoint.stress_db_loyalty_tiers' doesn't exist :: INSERT INTO `stress_db_loyalty_tiers` (store_id, tier_name, minimum_spend, minimum_points, discount_percentage, bonus_po
...
- **high** Stress test schema load failed in db_install_extensions.sql — Table 'martpoint.stress_db_loyalty_tiers' doesn't exist :: INSERT INTO `stress_db_loyalty_tiers` (store_id, tier_name, minimum_spend, minimum_points, discount_percentage, bonus_po
