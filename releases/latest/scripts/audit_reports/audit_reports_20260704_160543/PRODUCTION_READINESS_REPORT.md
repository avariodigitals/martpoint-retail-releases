...
- **high** Fresh installer schema import failed — Table 'ac_accounts' already exists
- **high** Upgrade migration failed — Row size too large. The maximum row size for the used table type, not counting BLOBs, is 8126. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs
- **high** Upgrade migration failed — Row size too large. The maximum row size for the used table type, not counting BLOBs, is 8126. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs
