...
- **[high]** Stress test schema load failed in db.txt
  - Root cause: Table 'stress_ac_accounts' already exists
...
- **high** Stress test schema load failed in db.txt — Table 'stress_ac_accounts' already exists
