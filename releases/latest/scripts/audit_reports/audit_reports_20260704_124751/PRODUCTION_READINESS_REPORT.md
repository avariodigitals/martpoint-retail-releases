...
- **[high]** Stress test schema load failed in db.txt
  - Root cause: Duplicate foreign key constraint name 'ac_accounts_ibfk_1'
...
- **high** Stress test schema load failed in db.txt — Duplicate foreign key constraint name 'ac_accounts_ibfk_1'
