...
- **[high]** Stress test schema load failed in db_install_extensions.sql
  - Root cause: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'NOT EXISTS `stress_db_installment_payments` (
  `id` int NOT NULL AUTO_INCREMENT' at line 1 :: CREATE TABLE `stress_IF` NOT EXISTS `stress_db_installment_payments` (
...
- **high** Stress test schema load failed in db_install_extensions.sql — You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'NOT EXISTS `stress_db_installment_payments` (
  `id` int NOT NULL AUTO_INCREMENT' at line 1 :: CREATE TABLE `stress_IF` NOT EXISTS `stress_db_installment_payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `plan_id` i
