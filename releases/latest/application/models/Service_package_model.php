...
class Service_package_model extends CI_Model {
    ...
    private function _ensure_tables() {
        $tables = ['db_service_packages', 'db_service_package_items', 'db_customer_packages', 'db_customer_package_redemptions'];
    ...
    public function get_details($id, $data = array()) {
        ...
        $data['expiry_date'] = is_valid_date($res->expiry_date) ? show_date($res->expiry_date) : '';
    ...
    public function redeem_package_item($customer_package_id, $item_id, $qty = 1, $notes = '', $service_order_id = null, $sale_id = null) {
        ...
        if (is_valid_date($cp->expiry_date) && $cp->expiry_date < date('Y-m-d')) {
