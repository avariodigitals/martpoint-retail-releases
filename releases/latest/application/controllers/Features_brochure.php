	...
	public function pdf(){
		...
		$modules = [
			...
			['📦 Inventory', 'Know exactly what you have, where it is, and when it expires.', [
				...
				'Multi-Branch Support — Manage stock across multiple branches.',
				'Stock Transfers — Move stock between branches with full audit trails.',
			...
			['🏢 Multi-Branch', 'One system. Many locations.', [
				...
				'Branch-Based Inventory — Each branch manages its own stock, branches, and suppliers.',
				...
				'Branch Privileges — Control which staff can access which branches.',
			], [6, 182, 212]],
		...
		$diffs = [
			...
			['Multi-Everything', 'Multi-store, multi-branch, multi-user, multi-currency'],
