										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											$str2.='<li>
												<a title="Pay" class="pointer" onclick="pay_now('.$purchase->id.')" >
													...
													$wa_share_purchase = get_whatsapp_share_url('purchase',$purchase->id);
													...
													<li>
														<a title="Share on WhatsApp" target="_blank" href="'.$wa_share_purchase['url'].'">
															<i class="fa fa-fw fa-whatsapp text-green"></i>WhatsApp
														</a>
													</li>';
