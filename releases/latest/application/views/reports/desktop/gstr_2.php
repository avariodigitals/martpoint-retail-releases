...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">GSTR-2 inward purchase summary</div>
  </div>
...
<script type="text/javascript">
  ...
  $("#view").on("click", function(){
    ...
    $.post($("#base_url").val() + "reports/show_gstr_2_report", { from_date: from_date, to_date: to_date, store_id: $("#store_id").val(), warehouse_id: $("#warehouse_id").val() }, function(result){
      setTimeout(function(){
...
<script>$(".report-gstr_2-active-li, .reports-menu").addClass("active");</script>
