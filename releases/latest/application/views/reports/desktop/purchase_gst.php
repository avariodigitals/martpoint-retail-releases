...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Item-wise purchase FSTR report by supplier</div>
  </div>
      ...
      <table class="table table-bordered table-hover" id="report-data" style="width:100%;">
        <thead>
          <tr class="bg-blue">
            ...
            <th><?= $this->lang->line('gst_number'); ?></th>
            ...
            <th><?= $this->lang->line('gst'); ?> %</th>
            <th><?= $this->lang->line('cgst'); ?> %</th>
            <th><?= $this->lang->line('cgst_amt'); ?></th>
            <th><?= $this->lang->line('sgst'); ?> %</th>
            <th><?= $this->lang->line('sgst_amt'); ?></th>
            <th><?= $this->lang->line('igst'); ?> %</th>
            <th><?= $this->lang->line('igst_amt'); ?></th>
            <th><?= $this->lang->line('round_off'); ?></th>
...
<script type="text/javascript">
  ...
  $("#view").on("click", function(){
    ...
    $.post($("#base_url").val() + "reports/show_purchase_gst_report", { from_date: from_date, to_date: to_date, store_id: $("#store_id").val(), warehouse_id: $("#warehouse_id").val(), supplier_id: supplier_id }, function(result){
      setTimeout(function(){
...
<script>$(".purchase_gst_report-active-li, .reports-menu").addClass("active");</script>
