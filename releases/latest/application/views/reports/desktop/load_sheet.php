...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Load sheet by brand, item and date range</div>
  </div>
...
<script type="text/javascript">
  ...
  $("#view").on("click", function(){
    ...
    $.post($("#base_url").val() + "reports/show_load_sheet", { from_date: from_date, to_date: to_date, store_id: $("#store_id").val() }, function(result){
      setTimeout(function(){
...
<script>$(".report-load-sheet-active-li, .reports-menu").addClass("active");</script>
