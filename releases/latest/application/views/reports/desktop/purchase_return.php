...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Track returned purchases by supplier and date range</div>
  </div>
...
<script src="<?php echo $theme_link; ?>js/report-purchase-return.js"></script>
...
<script>$(".report-purchase-return-active-li").addClass("active");</script>
