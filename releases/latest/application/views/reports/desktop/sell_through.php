...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Sell-through rate = units sold &divide; (units sold + current stock)</div>
  </div>
  ...
  <div class="mp-report-filter">
    ...
    <div class="mp-card-body">
      <div class="mp-form-grid">
        ...
        <div class="mp-form-group">
          <label for="min_rate">Min Sell-Through %</label>
...
<script>$(".report-sell-through-active-li").addClass("active");</script>
