...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Summary of production batches by status and date</div>
  </div>
      ...
      <div class="mp-form-grid">
        ...
        <div class="mp-form-group">
          ...
          <select class="form-control" id="status" name="status" style="width:100%;">
            ...
            <option value="<?= $st; ?>"><?= Production_batches_model::status_label($st); ?></option>
            <?php endforeach; ?>
          </select>
        </div>
...
<script src="<?php echo $theme_link; ?>js/report-production-summary.js"></script>
<script>$(".report-production-summary-active-li").addClass("active");</script>
