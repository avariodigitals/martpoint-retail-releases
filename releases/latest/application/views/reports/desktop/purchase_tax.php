...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View purchase tax by invoice and date range</div>
  </div>
      ...
      <table class="table table-bordered table-hover" id="report-data" style="width:100%;">
        <thead>
          <tr class="bg-blue">
            ...
            <th><?= $this->lang->line('tax_number'); ?></th>
...
<script type="text/javascript">
  ...
  $("#view").on("click", function(){
    ...
    $.post($("#base_url").val() + "reports/show_purchase_tax_report", { from_date: from_date, to_date: to_date, store_id: $("#store_id").val(), warehouse_id: $("#warehouse_id").val() }, function(result){
      setTimeout(function(){
...
<script>$(".report-purchase-tax-active-li").addClass("active");</script>
