...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View individual item sales by category and date range</div>
  </div>
    ...
    <div class="mp-card-body">
      <div class="mp-form-grid">
        ...
        <div class="mp-form-group">
          <label for="item_type"><?= $this->lang->line('item_type'); ?></label>
      ...
      <table class="table table-bordered table-hover" id="report-data" style="width:100%;">
        <thead>
          <tr class="bg-blue">
            ...
            <th><?= $this->lang->line('unit_price'); ?> (<?= $CI->currency(); ?>)</th>
...
<script>$(".report-sales-item-active-li").addClass("active");</script>
