...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View sales return refund payments by customer and payment type</div>
  </div>
...
<script type="text/javascript">
  $("#view").on("click", function(){
    ...
    $.post("show_sales_return_payments_report", { created_by: created_by, store_id: store_id, payment_type: payment_type, customer_id: customer_id, from_date: from_date, to_date: to_date }, function(result){
      setTimeout(function(){
...
<script>$(".report-sales-return-payments-active-li").addClass("active");</script>
