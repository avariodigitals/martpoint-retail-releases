...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View sales tax by invoice and date range</div>
  </div>
...
<script type="text/javascript">
  ...
  $("#view").on("click", function(){
    ...
    $.post($("#base_url").val() + "reports/show_sales_tax_report", { from_date: from_date, to_date: to_date, store_id: $("#store_id").val(), warehouse_id: $("#warehouse_id").val() }, function(result){
      setTimeout(function(){
...
<script>$(".report-sales-tax-active-li").addClass("active");</script>
