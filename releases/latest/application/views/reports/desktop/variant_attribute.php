...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">See which sizes, colours and styles move fastest</div>
  </div>
    ...
    <div class="mp-card-body">
      <div class="mp-form-grid">
        ...
        <div class="mp-form-group">
          ...
          <select class="form-control select2" id="attribute_type" name="attribute_type" style="width:100%;">
...
<script type="text/javascript">
  ...
  function load_records(){
    ...
    $.ajax({
      type: 'POST',
      url: base_url + 'reports/show_variant_attribute_report',
      data: data,
      cache: false,
      contentType: false,
      processData: false,
...
<script>$(".report-variant-attribute-active-li").addClass("active");</script>
