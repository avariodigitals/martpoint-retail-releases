            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="">
                    ...
                    $note_label = $is_pharmacy ? 'Client Complaints / Notes' : $this->lang->line('note');
                    $note_placeholder = $is_pharmacy ? 'Enter any client complaints, symptoms, or special instructions...' : '';
                    ?>
                    <label for="sales_note"><?= $note_label; ?></label>
                    <textarea type="text" class="form-control" id="sales_note" name="sales_note" placeholder="<?= $note_placeholder; ?>" <?= $is_pharmacy ? 'rows="3"' : ''; ?>></textarea>
                  ...
                  <div class="box-body">
                    ...
                    <div class="row" style="margin-top:10px;">
                      <div class="col-md-6">
                        ...
                        <select class="form-control" id="bnpl_payment_type" name="bnpl_payment_type" onchange="syncBnplPaymentType()">
                          <?= get_payment_modes_select_list(get_current_store_id(), get_default_payment_mode_code()); ?>
                        </select>
                      </div>
                      <div class="col-md-6">
