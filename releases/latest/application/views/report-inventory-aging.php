                     ...
                     <div class="box box-primary ">
                        ...
                        <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 <label for="aging_bucket" class="col-sm-2 control-label">Aging Bucket</label>
                                 <div class="col-sm-3">
                                    <select class="form-control select2 " id="aging_bucket" name="aging_bucket" >
                                 ...
                                 <label for="as_of_date" class="col-sm-2 control-label">As of Date</label>
                                 <div class="col-sm-3">
