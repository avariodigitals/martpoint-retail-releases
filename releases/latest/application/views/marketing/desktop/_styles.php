<?php
/**
 * Shared CSS + CSRF bootstrap for Marketing desktop content views.
 * Include at the top of each view: <?php $this->load->view('marketing/desktop/_styles'); ?>
 */
?>
<script>
...
/* ===== INPUT GROUPS (NIN verify, price level %, date pickers) ===== */
.input-group .mp-form-control:not(:last-child){border-top-right-radius:0!important;border-bottom-right-radius:0!important;border-right:none!important}
.input-group .mp-form-control:not(:first-child){border-top-left-radius:0!important;border-bottom-left-radius:0!important;border-left:none!important}
.input-group .input-group-addon{background:var(--mp-surface)!important;border:1px solid var(--mp-border)!important;color:var(--mp-muted)!important;padding:11px 14px!important;vertical-align:middle!important}
.input-group .input-group-addon:first-child{border-radius:10px 0 0 10px!important;border-right:none!important}
.input-group .input-group-addon:last-child{border-radius:0 10px 10px 0!important;border-left:none!important}
.input-group .input-group-btn .btn{border-top-left-radius:0!important;border-bottom-left-radius:0!important}
input[type="file"].mp-form-control{padding:9px 14px!important;background:var(--mp-bg)!important}
...
/* Legacy AdminLTE .box overlay used by theme JS (customers.js, suppliers.js, etc.) */
.box{position:relative!important}
.overlay{position:absolute!important;top:0!important;right:0!important;bottom:0!important;left:0!important;background:rgba(245,244,240,.85)!important;z-index:10!important;display:flex!important;align-items:center!important;justify-content:center!important;border-radius:inherit!important;color:var(--mp-primary)!important;font-size:24px!important}
</style>
