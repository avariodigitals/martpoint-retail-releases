...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View and manage discount coupons</div>
  </div>
  <?php if($CI->permissions('discountCouponAdd')) { ?>
  <a class="mp-qa-btn green" href="<?= base_url('discount_coupon/add'); ?>">
    <i class="fa fa-plus"></i> <?= $this->lang->line('createCoupon'); ?>
  </a>
  <?php } ?>
</div>
...
$(document).ready(function() {
  ...
  dom:'<"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr><"pull-right margin-left-10 "B>>>t<"row mp-dt-footer"<"col-sm-5"i><"col-sm-7"p>>',
      buttons: {
        ...
        "ajax": {
            "url": "<?= base_url('discount_coupon/ajax_list'); ?>",
            "type": "POST",
            "data": function(d){
...
<script>$(".discountCoupon-active-li").addClass("active").closest(".mp-nav-group").addClass("open");</script>
