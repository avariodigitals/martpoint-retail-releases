   ...
   <body class="hold-transition skin-blue  sidebar-mini">
      ...
      <!-- **********************MODALS END***************** -->
         ...
         <section class="content-header">
            <h1>
               <?= $page_title;?>
               <small>Add/Update <?= mp_label('item'); ?>s</small>
            </h1>
            <ol class="breadcrumb">
               <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i>Home</a></li>
               <li><a href="<?php echo $base_url; ?>items"><?= mp_label('item'); ?> List</a></li>
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4" id="attribute_types_box" style="display:none;">
                                 <label for="attribute_types">Attribute Types</label>
                                 <select class="form-control select2" id="attribute_types" name="attribute_types[]" multiple style="width: 100%;" >
                                    <?php
                              ...
                              <div class="form-group col-md-4">
                                 <label for="track_serial">
                                    <input type="checkbox" id="track_serial" name="track_serial" value="1" <?= (isset($track_serial) && $track_serial==1) ? 'checked' : ''; ?>>
                                    Require Serial Number <small class="text-muted">(POS will block checkout without it)</small>
                                 </label>
                                 <p class="text-muted" style="font-size:11px;margin-top:4px;">Used for phones, electronics, appliances.</p>
                              </div>
                              <?php } ?>

                              <?php if(mp_feature_enabled('imei_tracking')) { ?>
                              <div class="form-group col-md-4">
                                 <label for="track_imei">
                                    <input type="checkbox" id="track_imei" name="track_imei" value="1" <?= (isset($track_imei) && $track_imei==1) ? 'checked' : ''; ?>>
                                    Require IMEI <small class="text-muted">(POS will block checkout without it)</small>
                                 </label>
                                 <p class="text-muted" style="font-size:11px;margin-top:4px;">Required for mobile phones and cellular devices.</p>
                              </div>
                              <?php } ?>
                                    ...
                                    <div class="row" style="margin-bottom:15px;">
                                      ...
                                      <div class="col-md-3">
                                        <div class="checkbox" style="margin-top:0;">
                                          <label><input type="checkbox" id="track_serial" name="track_serial" value="1" <?= ($track_serial??0)==1?'checked':''; ?>> Require Serial Number for this product</label>
                                        </div>
                                      </div>
                                      <?php } ?>
                                      <?php if(mp_feature_enabled('imei_tracking')) { ?>
                                      <div class="col-md-3">
                                        <div class="checkbox" style="margin-top:0;">
                                          <label><input type="checkbox" id="track_imei" name="track_imei" value="1" <?= ($track_imei??0)==1?'checked':''; ?>> Require IMEI for this product</label>
                                        </div>
                                      </div>
                                      <?php } ?>
                                    </div>
                                    ...
                                    <table class="table table-bordered table-condensed" id="barcode_table">
                                      <thead>
                                        <tr>
                                          ...
                                          <th>Qty in Stock</th>
                                          <?php if(mp_feature_enabled('expiry_tracking')) { ?><th>Expiry</th><?php } ?>
                                          <?php if(mp_feature_enabled('mfg_tracking')) { ?><th>MFG Date</th><?php } ?>
                                      ...
                                      <tbody>
                                        ...
                                        <tr id="barcode_row_<?=$bi;?>">
                                          ...
                                          <?php if(mp_feature_enabled('expiry_tracking')) { ?><td><input type="date" class="form-control" name="barcode_expire_date[]" value="<?=htmlspecialchars($brow->expire_date ?? '');?>"></td><?php } ?>
                                          <?php if(mp_feature_enabled('mfg_tracking')) { ?><td><input type="date" class="form-control" name="barcode_mfg_date[]" value="<?=htmlspecialchars($brow->mfg_date ?? '');?>"></td><?php } ?>
                                        ...
                                        <tr id="barcode_row_1">
                                          ...
                                          <?php if(mp_feature_enabled('expiry_tracking')) { ?><td><input type="date" class="form-control" name="barcode_expire_date[]" value="<?=htmlspecialchars($expire_date);?>"></td><?php } ?>
                                          <?php if(mp_feature_enabled('mfg_tracking')) { ?><td><input type="date" class="form-control" name="barcode_mfg_date[]" value="<?=htmlspecialchars($mfg_date);?>"></td><?php } ?>
                                  ...
                                  <div class="box box-info ">
                                    <div class="">
                                      <div class="box-header">
                                        <div class="col-md-4 col-md-offset-4 d-flex justify-content" >
                                          <div class="input-group">
                                        ...
                                        <div class="col-md-4 text-right" style="padding-top:5px;">
                                          <button type="button" class="btn btn-sm btn-purple" id="btn_matrix_generator" data-toggle="modal" data-target="#matrix_generator_modal" style="background:#7C3AED;color:#fff;">
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="variant_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:8%"><?= $this->lang->line('image'); ?></th>
         ...
         <!-- Variant Matrix Generator Modal (fashion + any variant-based industry) -->
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               ...
               <div class="modal-body">
                 ...
                 <div class="row" id="matrix_attribute_container">
                   <!-- attribute rows injected here -->
                 </div>
      ...
      <script src="<?php echo $theme_link; ?>js/items.js?v=14"></script>
      ...
      <script>
        ...
        function addBarcodeRow(){
          ...
          var html = '<tr id="barcode_row_'+barcodeRowIndex+'">'+
            ...
            <?php } ?><?php if(mp_feature_enabled('mfg_tracking')) { ?>'<td><input type="date" class="form-control" name="barcode_mfg_date[]"></td>'+
      ...
      <script type="text/javascript">
        ...
        function toggleAttributeTypesBox(){
          ...
          if(ig == 'Variants'){
            $("#attribute_types_box").show();
            if($("#attribute_types").hasClass('select2-hidden-accessible')){
              $("#attribute_types").select2('destroy');
            }
            $("#attribute_types").select2({width:'100%'});
          } else {
            $("#attribute_types_box").hide();
          }
        }
        ...
        function loadMatrixAttributeMap(){
          $.get(base_url+'items/get_variant_attribute_map', function(res){
        ...
        $("#btn_generate_matrix").on('click', function(){
          ...
          $.post(base_url+'items/generate_matrix_rows', {
