...
.bl-deco{ position:absolute; border-radius:50%; opacity:0.06; pointer-events:none; }
...
<?php foreach($homepage_sections as $key => $section){ if(!$section->is_enabled) continue; switch($key){
