...
if(!empty($homepage_sections['hero_banner']) && $homepage_sections['hero_banner']->is_enabled){
  include(APPPATH.'views/themes/laundry/sections/hero.php');
  include(APPPATH.'views/themes/laundry/sections/how_it_works.php');
}
foreach($homepage_sections as $key => $section){
  ...
  switch($key){
    ...
    case 'featured_categories': include(APPPATH.'views/themes/laundry/sections/featured_categories.php'); break;
    case 'featured_products': include(APPPATH.'views/themes/shared/sections/featured_products.php'); break;
    case 'featured_services': include(APPPATH.'views/themes/laundry/sections/featured_services.php'); break;
