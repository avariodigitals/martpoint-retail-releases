...
<div class="mp-nav" id="mp-nav">
  <div class="mp-nav-inner">
    <a href="<?= base_url('store/' . $slug . '/services'); ?>" class="mp-nav-link">All Services</a>
    <?php if(!empty($serviceCats)): foreach(array_slice($serviceCats, 0, 5) as $cat): ?>
...
<div id="mobile-menu" style="display:none; position:fixed; top:0; left:0; bottom:0; width:280px; background:#fff; z-index:901; padding:24px; box-shadow:4px 0 24px rgba(0,0,0,0.1);">
  ...
  <div style="display:flex; flex-direction:column; gap:16px;">
    ...
    <a href="<?= base_url('store/' . $slug . '/services'); ?>" style="font-size:16px; font-weight:600; color:var(--mp-dark);" onclick="toggleMobileMenu()">All Services</a>
