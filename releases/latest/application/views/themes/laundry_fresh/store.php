<?php
$theme_css_extra = '<style></style>';
if(!empty($homepage_sections['hero_banner']) && $homepage_sections['hero_banner']->is_enabled){
  include(APPPATH.'views/themes/laundry_fresh/sections/hero.php');
  include(APPPATH.'views/themes/laundry_fresh/sections/quick_order.php');
  include(APPPATH.'views/themes/laundry_fresh/sections/how_it_works.php');
  include(APPPATH.'views/themes/laundry_fresh/sections/track_order.php');
  include(APPPATH.'views/themes/laundry_fresh/sections/branches.php');
}
foreach($homepage_sections as $key => $section){
  if(!$section->is_enabled) continue;
  switch($key){
    case 'hero_banner': break;
    ...
    case 'featured_categories': include(APPPATH.'views/themes/laundry_fresh/sections/featured_categories.php'); break;
    case 'featured_products': include(APPPATH.'views/themes/shared/sections/featured_products.php'); break;
    case 'featured_services': include(APPPATH.'views/themes/laundry_fresh/sections/featured_services.php'); break;
