...
<style>
  ...
  .flh-search input { width:100%; padding:10px 14px 10px 36px; border:1px solid #E8E4DC; border-radius:12px; font-family:'Lora',serif; font-size:13px; outline:none; background:#F9F7F2; transition:border-color .2s; }
