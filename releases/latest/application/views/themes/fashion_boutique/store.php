...
<style>
  ...
  .bl-hours-row { display:flex; justify-content:center; padding:12px 0; border-bottom:1px solid var(--bl-soft); font-family:'Lora',serif; font-size:14px; }
...
<?php
    ...
    case 'trust_badges':
      ...
      if(empty($blBadges) || !is_array($blBadges)) break;
?>
<!-- TRUST BADGES -->
<div class="bl-values">
...
<div class="bl-section">
  <div class="bl-container">
    <div class="bl-newsletter">
      ...
      <form class="bl-newsletter-form" onsubmit="return mpNewsletterSubmit(event)">
  ...
  <div class="bl-container">
    ...
    <div class="bl-hours-grid">
      ...
      <div class="bl-hours-row">
        <span class="bl-hours-line"><?= htmlspecialchars($line); ?></span>
      </div>
      <?php endforeach; ?>
    </div>
  </div>
