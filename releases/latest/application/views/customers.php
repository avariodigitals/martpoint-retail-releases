                           ...
                           <div class="box-body">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-10">
                                    ...
                                    <!-- </div>
                                    <div class="form-group"> -->
                                       <label for="mobile" class="col-sm-2 control-label"><?= $this->lang->line('mobile'); ?> <span class="text-danger">*</span></label>
                                       <div class="col-sm-4">
                                          <input type="text" class="form-control no_special_char_no_space" id="mobile" name="mobile" placeholder="+1234567890" value="<?php print $mobile; ?>" required >
