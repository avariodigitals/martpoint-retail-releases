    ...
    <section class="invoice">
          ...
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td>".format_qty($res2->purchase_qty)."</td>";
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td><?= $CI->currency($tot_unit_total_cost) ;?></td>
      ...
      <div class="row no-print">
        ...
        <div class="col-xs-6 text-right">
          ...
          <a href="<?php $wa_share = get_whatsapp_share_url('purchase',$purchase_id); echo $wa_share['url']; ?>" target="_blank" class="btn" style="background-color:#25D366;color:#fff;">
