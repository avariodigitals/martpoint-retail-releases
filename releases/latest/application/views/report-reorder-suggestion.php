                  ...
                  <div class="col-md-12">
                     <div class="box box-primary ">
                        <div class="box-header with-border">
                           <h3 class="box-title">Purchase recommendations based on sell-through velocity, not guesswork</h3>
                        </div>
                        <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              <div class="form-group">
                                 ...
                                 <label for="days_window" class="col-sm-2 control-label">Analysis Window (days)</label>
                                 <div class="col-sm-3">
