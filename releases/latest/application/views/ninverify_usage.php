<?php
/* NIN/BVN usage summary page — content-only view for mp_layout */
?>
...
<div class="mp-page-head"><h1 class="mp-page-title"><?= $page_title; ?> <small>Billing & Usage Dashboard</small></h1></div>
...
<script>
$('.ninverify_usage-active-li').addClass('active');
$('.ninverify_usage-active-li').closest(".mp-nav-group").addClass("open");
</script>
