                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="attendance" > <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[attendance]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="attendance_all" id='attendance_edit' name="permission[attendance_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="attendance_all" id='attendance_view' name="permission[attendance_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!-- Roles -->
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="payment_modes"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[payment_modes]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="payment_modes_all" id='payment_modes_add' name="permission[payment_modes_add]"> <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="payment_modes_all" id='payment_modes_edit' name="permission[payment_modes_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="payment_modes_all" id='payment_modes_delete' name="permission[payment_modes_delete]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="payment_modes_all" id='payment_modes_view' name="permission[payment_modes_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!-- PAYSTACK SETTINGS -->
                                       <tr>
                                          <td><?= $i++;?></td>
                                          <td>Paystack Settings</td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="paystack"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[paystack]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="paystack_all" id='paystack_settings' name="permission[paystack_settings]"> <?= $this->lang->line('view'); ?> / <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!-- EXPIRY SETTINGS -->
                                       <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="expiry"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[expiry]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="expiry_all" id='expiry_settings' name="permission[expiry_settings]"> <?= $this->lang->line('view'); ?> / <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                       <!-- ONLINE STORE -->
                                       <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="online_store"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[online_store]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="online_store_all" id='online_store_view' name="permission[online_store_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="online_store_all" id='online_store_edit' name="permission[online_store_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                       <!--Warehouse  -->
                                       ...
                                       <?php if(warehouse_module()){ ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="dashboard_all" id='recent_sales_invoice_list' name="permission[recent_sales_invoice_list]"> <?= $this->lang->line('recent_sales_invoice_list'); ?>
                                              </label></div>
                                          </td>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('discountCoupon'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="discountCoupon" > <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[discountCoupon]" value="on">

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="discountCoupon_all" id='discountCouponAdd' name="permission[discountCouponAdd]" > <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="discountCoupon_all" id='discountCouponEdit' name="permission[discountCouponEdit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="discountCoupon_all" id='discountCouponDelete' name="permission[discountCouponDelete]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="discountCoupon_all" id='discountCouponView' name="permission[discountCouponView]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('customerCoupon'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="customerCoupon" > <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[customerCoupon]" value="on">

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customerCoupon_all" id='customerCouponAdd' name="permission[customerCouponAdd]" > <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customerCoupon_all" id='customerCouponEdit' name="permission[customerCouponEdit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customerCoupon_all" id='customerCouponDelete' name="permission[customerCouponDelete]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="customerCoupon_all" id='customerCouponView' name="permission[customerCouponView]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <div class="checkbox icheck hide"><label>
                                                <input type="checkbox" class="reports_all" id='delivery_sheet_report' name="permission[delivery_sheet_report]" > <?= $this->lang->line('delivery_sheet_report'); ?>
                                              </label></div>
                                              <div class="checkbox icheck hide"><label>
                                                <input type="checkbox" class="reports_all" id='load_sheet_report' name="permission[load_sheet_report]" > <?= $this->lang->line('load_sheet_report'); ?>
                                              </label></div>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='return_items_report' name="permission[return_items_report]"> <?= $this->lang->line('return_items_report'); ?>
                                              </label></div>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='sales_return_payments' name="permission[sales_return_payments]"> <?= $this->lang->line('sales_return_payments'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='sales_gst_report' name="permission[sales_gst_report]"> <?= $this->lang->line('sales_gst_report'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='purchase_gst_report' name="permission[purchase_gst_report]"> <?= $this->lang->line('purchase_gst_report'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='stock_transfer_report' name="permission[stock_transfer_report]"> <?= $this->lang->line('stock_transfer_report'); ?>
                                              </label></div>

                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='sales_summary_report' name="permission[sales_summary_report]"> <?= $this->lang->line('sales_summary_report'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="approvals"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[approvals]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="approvals_all" id='approval_settings_edit' name="permission[approval_settings_edit]"> Edit Approval Settings
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="approvals_all" id='approval_logs_view' name="permission[approval_logs_view]"> View Approval Logs
                                              </label></div>
                                              <div class="checkbox icheck"><label>
