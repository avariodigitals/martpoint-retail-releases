                            ...
                            if(isset($sales_id)){
                              ...
                              if($q4->num_rows()>0){
                                ...
                                foreach ($q4->result() as $res4) {
                                  $confirmLabel = ($res4->confirmation_status == 1) ? '' : ' <span style="font-size:9px;color:#f39c12;">[Pending]</span>';
                                  $refLabel = (!empty($res4->payment_reference)) ? '<br><span style="font-size:9px;color:#666;">Ref: '.$res4->payment_reference.'</span>' : '';
                                  echo "<tr>";
                                  echo '<td style="border:1px solid;padding-left:2px;">'.$i++."</td>";
                                  echo '<td style="border:1px solid;padding-left:2px;">';
                                    echo $res4->payment_type . $confirmLabel . $refLabel;
                                  echo '</td>';
