...
<div class="mp-section">
  <div class="mp-page-head">
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap;">
      ...
      <a class="mp-qa-btn" href="<?= base_url('import/attributes'); ?>" style="background:var(--mp-bg);color:var(--mp-ink);border:1px solid var(--mp-border);">
        ...
        <?= $this->lang->line('import_attributes'); ?>
      </a>
...
$(document).ready(function(){
    ...
    $("#select_all").on("ifChanged ifClicked change", function(){
