                          ...
                          <div class="col-md-12">
                            <div class="box-body">
                              <div class="form-group" style="display:flex;align-items:center;gap:8px;">
                                ...
                                <input type="checkbox" id="unit_is_default" name="is_default" value="1" style="width:auto;margin:0;">
                                <label for="unit_is_default" style="margin:0;font-weight:normal;cursor:pointer;">Set as default unit for new items</label>
                              </div>
                            </div>
                          </div>
