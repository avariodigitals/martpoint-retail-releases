   ...
   <body class="hold-transition skin-blue sidebar-mini">
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-blue">
                                    ...
                                    <th style=""><?= $this->lang->line('cgst_amt'); ?></th>
                                    <th style=""><?= $this->lang->line('sgst'); ?> %</th>
                                    <th style=""><?= $this->lang->line('sgst_amt'); ?></th>
                                    <th style=""><?= $this->lang->line('igst'); ?> %</th>
                                    <th style=""><?= $this->lang->line('igst_amt'); ?></th>
                                
                                    <th style=""><?= $this->lang->line('round_off'); ?></th>
                                    <th style=""><?= $this->lang->line('total'); ?></th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
      ...
      <script>
         function convert_excel(type, fn, dl) {
             ...
             return dl ?
                 ...
                 XLSX.writeFile(wb, fn || ('Sales-GST-Report.' + (type || 'xlsx')));
         }
      ...
      <script type="text/javascript">
        $("#view").on("click",function(){
            ...
            $.post($("#base_url").val()+"reports/show_sales_gst_report",{from_date:from_date,to_date:to_date,store_id:$("#store_id").val(),warehouse_id:$("#warehouse_id").val(),customer_id:customer_id},function(result){
                //alert(result);
                setTimeout(function() {
      ...
      <script>$(".sales_gst_report-active-li , .reports-menu").addClass("active");</script>
   </body>
</html>
