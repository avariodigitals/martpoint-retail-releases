...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo $base_url; ?>dashboard" class="logo" title="<?= htmlspecialchars($this->session->userdata('store_name') ?? 'Dashboard'); ?>">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="btn-group hidden-xs">
            ...
            <ul class="dropdown-menu" >
                  ...
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>customers/add" ><h4><i class="fa fa-plus text-green"></i> <?= mp_label('customer'); ?></h4></a>
                  </li> 
                  <?php } ?>
                  ...
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>items/add" ><h4><i class="fa fa-plus text-green"></i> <?= mp_label('item'); ?></h4></a>
                  </li> 
                  <?php } ?>
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <?php } ?>
          <?php if(true && $CI->permissions('pos')) { ?>
          <li class="text-center" id="">
            <a title="POS [Shift+P]" href="<?php echo $base_url; ?>pos"><i class="fa fa-plus-square " ></i> <span class="hidden-xs">POS</span></a>   
          </li>
          <?php } ?>
          ...
          <?php
            if($CI->db->table_exists('db_subscription_license')){
              ...
              if($sub_status['status'] !== 'NOT_ACTIVATED'):
                ...
                $days_label = ($sub_status['days_left'] <= 0) ? 'Expired' : $sub_status['days_left'] . '<span class="hidden-xs"> Days</span>';
                if(special_access()){
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- Store identity on mobile -->
      <div class="mp-store-name visible-xs">
        <?= htmlspecialchars($this->session->userdata('store_name') ?? 'MartPoint'); ?>
      </div>

      <!-- POS CTA: persistent quick-access button -->
      <?php if($CI->permissions('pos')) { ?>
      <div class="mp-pos-cta-wrap">
        <a href="<?php echo $base_url; ?>pos" class="mp-pos-cta" title="Open POS Checkout (Shift+P)">
          <i class="fa fa-plus-square"></i> <span>Start Sale</span>
        </a>
      </div>
      <?php } ?>
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <!-- 2. SALES (includes Quotations) -->
        <?php if(true){?>
        <?php if($CI->permissions('sales_add')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view') || $CI->permissions('sales_return_add') || $CI->permissions('quotation_add') || $CI->permissions('quotation_view')) { ?>
        <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li quotation_list-active-li quotation-active-li quotation-return-active-li quotation-return-list-active-li treeview">
          <a href="#">
            <i class=" fa fa-shopping-cart text-orange"></i> <span>Sales</span>
          ...
          <ul class="treeview-menu">
            ...
            <?php if($CI->permissions('pos')) { ?>
            <li class="pos-active-li"><a href="<?php echo $base_url; ?>pos"><i class="fa fa-plus-square-o  "></i> <span>POS Checkout</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_add')) { ?>
            <li class="sales-active-li"><a href="<?php echo $base_url; ?>sales/add"><i class="fa fa-plus-square-o "></i> <span>New Sale</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_view')) { ?>
            <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales"><i class="fa fa-list "></i> <span>Sales History</span></a></li>
            <?php } ?>
            ...
            <li class="sales-return-list-active-li "><a href="<?php echo $base_url; ?>sales_return"><i class="fa fa-list "></i> <span>Sales Returns</span></a></li>
            <?php } ?>
            <!-- Quotations (merged from separate block) -->
            <?php if($CI->permissions('quotation_add')) { ?>
            <li class="quotation-active-li"><a href="<?php echo $base_url; ?>quotation/add"><i class="fa fa-file-text-o "></i> <span>New Quotation</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('quotation_view')) { ?>
            <li class="quotation_list-active-li"><a href="<?php echo $base_url; ?>quotation"><i class="fa fa-list "></i> <span>Quotation History</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <!-- 3. CATALOG (includes Price Catalogue from Operations) -->
        <?php if(true){?>
        <?php if($CI->permissions('services_add') || $CI->permissions('services_view') || $CI->permissions('items_add') || $CI->permissions('items_view') || $CI->permissions('items_category_add') || $CI->permissions('items_category_view') || $CI->permissions('brand_add') || $CI->permissions('brand_view') || $CI->permissions('attributes_add') || $CI->permissions('attributes_view') || $CI->permissions('print_labels') || $CI->permissions('import_items') || $CI->permissions('import_services') || $CI->permissions('variant_view') || $CI->permissions('services_view') || $CI->permissions('service_packages_view') || (mp_feature_enabled('price_catalogue') && (is_admin() || is_store_admin())) ) { ?>
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li attributes-active-li attributes-view-active-li labels-active-li import_items-active-li services-active-li import_services-active-li variants-active-li variants_list-active-li services-active-li service-packages-active-li price-catalogue-active-li treeview">
          <a href="#">
            <i class="fa fa-cubes text-navy"></i> <span>Catalog</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('items_add')) { ?>
            <li class="items-active-li"><a href="<?php echo $base_url; ?>items/add"><i class="fa fa-plus-square-o "></i> <span>New <?= mp_label('item'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('services_add') && service_module()) { ?>
            <li class="services-active-li"><a href="<?php echo $base_url; ?>services/add"><i class="fa fa-plus-square-o "></i> <span>New Service</span></a></li>
            <?php } ?>
            ...
            <li class="items-list-active-li"><a href="<?php echo $base_url; ?>items"><i class="fa fa-list "></i> <span><?= mp_label('item'); ?> List</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('items_category_view')) { ?>
            <li class="category-view-active-li"><a href="<?php echo $base_url; ?>category/view"><i class="fa fa-list "></i> <span>Categories</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('brand_view')) { ?>
            <li class="brand-view-active-li"><a href="<?php echo $base_url; ?>brands/view"><i class="fa fa-list "></i> <span>Brands</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('attributes_view')) { ?>
            <li class="attributes-view-active-li"><a href="<?php echo $base_url; ?>attributes"><i class="fa fa-tags "></i> <span><?= $this->lang->line('attributes'); ?></span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <!-- Price Catalogue (moved from Operations) -->
            <?php if(mp_feature_enabled('price_catalogue') && (is_admin() || is_store_admin())) { ?>
            <li class="price-catalogue-active-li"><a href="<?= $base_url; ?>operations/price_catalogue"><i class="fa fa-tags "></i> <span>Price Catalogue</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <!-- PROMOTIONS (Fashion Intelligence) -->
        <?php if(true && $CI->permissions('promotions_manage')) { ?>
        <li class="promotions-list-active-li promotions-active-li treeview">
          <a href="#"><i class="fa fa-tag text-maroon"></i> <span><?= $this->lang->line('promotions'); ?></span>
          </a>
          <ul class="treeview-menu">
            <li class="promotions-list-active-li"><a href="<?php echo $base_url; ?>promotions"><i class="fa fa-list"></i> <span><?= $this->lang->line('promotion_list'); ?></span></a></li>
            <li class="promotion_form-active-li"><a href="<?php echo $base_url; ?>promotions/add"><i class="fa fa-plus"></i> <span><?= $this->lang->line('promotion_add'); ?></span></a></li>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="purchase-list-active-li purchase-active-li purchase-returns-active-li purchase-returns-list-active-li treeview">
          <a href="#">
            <i class="fa fa-cart-arrow-down text-green"></i> <span>Purchases</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('purchase_add')) { ?>
            <li class="purchase-active-li"><a href="<?php echo $base_url; ?>purchase/add"><i class="fa fa-plus-square-o "></i> <span>New Purchase</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('purchase_view')) { ?>
            <li class="purchase-list-active-li"><a href="<?php echo $base_url; ?>purchase"><i class="fa fa-list "></i> <span>Purchase History</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('purchase_return_view')) { ?>
            <li class="purchase-returns-list-active-li"><a href="<?php echo $base_url; ?>purchase_return"><i class="fa fa-list "></i> <span>Purchase Returns</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="pos-active-li stock_adjustment_list-active-li stock_adjustment-active-li stock_adjustment-return-active-li stock_adjustment-return-list-active-li stock_transfer-active-li stock_transfer_list-active-li treeview">
          <a href="#">
            <i class=" fa fa-refresh text-yellow"></i> <span>Inventory</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="stock_adjustment_list-active-li stock_adjustment-active-li"><a href="<?php echo $base_url; ?>stock_adjustment"><i class="fa fa-list "></i> <span>Stock Adjustments</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('stock_transfer_view') && warehouse_module()) { ?>
            <li class="stock_transfer_list-active-li stock_transfer-active-li"><a href="<?php echo $base_url; ?>stock_transfer/view"><i class="fa fa-list "></i> <span>Stock Transfers</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <!-- 6. CUSTOMERS (includes Customer Advances) -->
        <?php if(true){?>
        <?php if($CI->permissions('customers_add') || $CI->permissions('customers_view') || $CI->permissions('import_customers') || $CI->permissions('suppliers_add') || $CI->permissions('suppliers_view') || $CI->permissions('import_suppliers') || $CI->permissions('cust_adv_payments_add')  || $CI->permissions('cust_adv_payments_view')) { ?>
        <li class="customers-view-active-li customers-active-li import_customers-active-li suppliers-list-active-li suppliers-active-li import_suppliers-active-li list-active-li create-active-li treeview">
          <a href="#">
            <i class="fa fa-address-book text-purple"></i> <span><?= mp_label('customer'); ?>s</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('customers_add')) { ?>
            <li class="customers-active-li"><a href="<?php echo $base_url; ?>customers/add"><i class="fa fa-plus-square-o "></i> <span>New <?= mp_label('customer'); ?></span></a></li>
            <?php } ?>
            ...
            <li class="suppliers-list-active-li"><a href="<?php echo $base_url; ?>suppliers"><i class="fa fa-list "></i> <span>Supplier List</span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <!-- Customer Advances (merged from separate block) -->
            <?php if($CI->permissions('cust_adv_payments_add')) { ?>
            <li class="create-active-li"><a href="<?php echo $base_url; ?>customers_advance/add"><i class="fa fa-hand-o-up "></i> <span>New Advance</span></a></li>
            <?php } ?>
        ...
        <!-- 7. FINANCE (Accounts & Cash + Expenses merged) -->
        <?php if(true){?>
        <?php if(($CI->permissions('accounts_add') || $CI->permissions('accounts_view') || $CI->permissions('journal_add') || $CI->permissions('journal_view') || $CI->permissions('money_transfer_view') || $CI->permissions('money_deposit_view') || $CI->permissions('cash_transactions') || $CI->permissions('tills_view')) && accounts_module() || $CI->permissions('expense_add') || $CI->permissions('expense_view') || $CI->permissions('expense_category_add') || $CI->permissions('expense_category_view') || $CI->permissions('tills_view')) { ?>
        <li class="accounts_list-active-li accounts-active-li journal-active-li journal_list-active-li money_transfer-active-li money_transfer_list-active-li money_deposit-active-li money_deposit_list-active-li cash_transactions-active-li tills-active-li expense-list-active-li expense-active-li expense-category-active-li expense-category-list-active-li treeview">
          <a href="#">
            <i class="fa fa-money text-maroon"></i> <span>Finance</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="accounts-active-li"><a href="<?php echo $base_url; ?>accounts/add"><i class="fa fa-plus-square-o "></i> <span>New Account</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('accounts_view')) { ?>
            <li class="accounts_list-active-li"><a href="<?php echo $base_url; ?>accounts"><i class="fa fa-list "></i> <span>Account List</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('money_transfer_view')) { ?>
            <li class="money_transfer_list-active-li"><a href="<?php echo $base_url; ?>money_transfer"><i class="fa fa-list "></i> <span>Money Transfers</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('money_deposit_view')) { ?>
            <li class="money_deposit_list-active-li"><a href="<?php echo $base_url; ?>money_deposit"><i class="fa fa-list "></i> <span>Deposits</span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <?php } ?>
            <!-- Tills (independent of accounts_module flag) -->
            <?php if($CI->permissions('tills_view')) { ?>
            <li class="tills-active-li"><a href="<?php echo $base_url; ?>tills"><i class="fa fa-inbox "></i> <span><?= $this->lang->line('tills'); ?></span></a></li>
            <?php } ?>
            <!-- Expenses (merged from separate block) -->
            <?php if($CI->permissions('expense_view')) { ?>
            <li class="expense-list-active-li"><a href="<?php echo $base_url; ?>expense"><i class="fa fa-list "></i> <span>Expense List</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('expense_category_view')) { ?>
            <li class="expense-category-list-active-li "><a href="<?php echo $base_url; ?>expense/category"><i class="fa fa-list "></i> <span>Expense Categories</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="marketing-active-li coupon-active-li loyalty-active-li gift-cards-active-li store-credit-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
            <?php } ?>
            <!-- Loyalty & Rewards (merged from separate block) -->
            <?php if($CI->permissions('loyalty_view') && mp_feature_enabled('loyalty')) { ?>
            <li class="loyalty-active-li"><a href="<?php echo $base_url; ?>loyalty"><i class="fa fa-dashboard"></i> <span>Loyalty Dashboard</span></a></li>
            <li><a href="<?php echo $base_url; ?>loyalty/settings"><i class="fa fa-cog"></i> <span>Loyalty Settings</span></a></li>
            <li><a href="<?php echo $base_url; ?>loyalty/tiers"><i class="fa fa-sitemap"></i> <span><?= mp_label('customer'); ?> Tiers</span></a></li>
        ...
        <!-- 9. REPORTS -->
        <?php if($CI->permissions('supplier_items_report') || $CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('purchase_return_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report') || $CI->permissions('expired_items_report') || $CI->permissions('seller_points_report') || $CI->permissions('customer_orders_report') || $CI->permissions('stock_transfer_report') || $CI->permissions('sales_summary_report') || $CI->permissions('sales_return_payments') || ($CI->permissions('z_report') && mp_feature_enabled('cashier_shifts')) || ($CI->permissions('cashier_shifts_manage') && mp_feature_enabled('cashier_shifts')) || $CI->permissions('receivables_aging_report') || $CI->permissions('inventory_aging_report') || $CI->permissions('cash_flow_report') || $CI->permissions('variant_attribute_report') || $CI->permissions('sell_through_report') || $CI->permissions('reorder_suggestion_report') ) { ?>
        <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li report-stock-transfer-active-li reports-menu report-sales-summary-active-li report-sales-return-payments-active-li report-z-active-li cashier-shifts-active-li cashier-shift-open-active-li cashier-shift-close-active-li report-receivables-aging-active-li report-inventory-aging-active-li report-cash-flow-active-li report-variant-attribute-active-li report-sell-through-active-li report-reorder-suggestion-active-li treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="report-daily-summary-active-li"><a href="<?php echo $base_url; ?>dashboard/daily_summary" ><i class="fa fa-files-o "></i> <span>Daily Business Summary</span></a></li>
            <?php if($CI->permissions('z_report') && mp_feature_enabled('cashier_shifts')) { ?>
            <li class="report-z-active-li"><a href="<?php echo $base_url; ?>cashier_shifts" ><i class="fa fa-money "></i> <span><?= $this->lang->line('z_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('cashier_shifts_manage') && mp_feature_enabled('cashier_shifts')) { ?>
            <li class="cashier-shifts-active-li"><a href="<?php echo $base_url; ?>cashier_shifts/manage" ><i class="fa fa-clock-o "></i> <span>Open / Close Shift</span></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('receivables_aging_report')) { ?>
            <li class="report-receivables-aging-active-li"><a href="<?php echo $base_url; ?>reports/receivables_aging" ><i class="fa fa-hourglass-half "></i> <span><?= $this->lang->line('receivables_aging_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('inventory_aging_report')) { ?>
            <li class="report-inventory-aging-active-li"><a href="<?php echo $base_url; ?>reports/inventory_aging" ><i class="fa fa-cubes "></i> <span><?= $this->lang->line('inventory_aging_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('cash_flow_report')) { ?>
            <li class="report-cash-flow-active-li"><a href="<?php echo $base_url; ?>reports/cash_flow" ><i class="fa fa-tachometer "></i> <span><?= $this->lang->line('cash_flow_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('variant_attribute_report')) { ?>
            <li class="report-variant-attribute-active-li"><a href="<?php echo $base_url; ?>reports/variant_attribute" ><i class="fa fa-star text-yellow"></i> <span><?= $this->lang->line('variant_attribute_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('sell_through_report')) { ?>
            <li class="report-sell-through-active-li"><a href="<?php echo $base_url; ?>reports/sell_through" ><i class="fa fa-line-chart "></i> <span><?= $this->lang->line('sell_through_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('reorder_suggestion_report')) { ?>
            <li class="report-reorder-suggestion-active-li"><a href="<?php echo $base_url; ?>reports/reorder_suggestion" ><i class="fa fa-shopping-basket "></i> <span><?= $this->lang->line('reorder_suggestion_report'); ?></span></a></li>
            <?php } ?>
            <?php } ?>
            ...
            <li class="sales_gst_report-active-li"><a href="<?php echo $base_url; ?>reports/sales_gst_report" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('sales_gst_report'); ?></span></a></li>
            <?php } ?>
            ...
            <li class="report-supplier_items-active-li"><a href="<?php echo $base_url; ?>reports/supplier_items" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('supplier_items_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_report')) { ?>
            ...
            <li class="report-return-item-active-li"><a href="<?php echo $base_url; ?>reports/return_item" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('return_items_report'); ?></span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <?php if(($CI->permissions('approval_logs_view') || is_store_admin() || $this->session->userdata('role_id') == 1) && mp_feature_enabled('manager_approvals')) { ?>
            ...
            <li class="report-sales-return-payments-active-li"><a href="<?php echo $base_url; ?>reports/sales_return_payments" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('sales_return_payments'); ?></a></li>
            <?php } ?>
            <?php if($CI->permissions('stock_transfer_report')) { ?>
            <li class="report-stock-transfer-active-li"><a href="<?php echo $base_url; ?>reports/stock_transfer" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('stock_transfer_report'); ?></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_summary_report')) { ?>
            <li class="report-sales-summary-active-li"><a href="<?php echo $base_url; ?>reports/sales_summary" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('sales_summary_report'); ?></a></li>
            <?php } ?>
        ...
        <li class="online-store-active-li online-store-settings-active-li online-store-orders-active-li online-store-services-active-li online-store-qr-active-li online-store-products-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="online-store-active-li"><a href="<?php echo $base_url; ?>online_store"><i class="fa fa-dashboard"></i> Store Dashboard</a></li>
            <?php } ?>
        ...
        <li class="custom-orders-active-li production-schedule-active-li recipes-active-li recipe-categories-active-li memberships-active-li treatment-notes-active-li medical-notes-active-li kitchen-active-li laundry-active-li production-active-li public-catalogue-active-li warranty-lookup-active-li staff-active-li staff-commission-active-li table-management-active-li treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
            <?php if(mp_feature_enabled('medical_notes')) { ?>
            <li class="medical-notes-active-li"><a href="<?= $base_url; ?>operations/medical_notes"><i class="fa fa-file-medical-o"></i> Medical Notes</a></li>
            <?php } ?>
            ...
            <?php } ?>
            <!-- Staff (merged from separate block) -->
            <?php if($has_staff) { ?>
            ...
            <?php } ?>
            <?php } ?>
            <!-- Table Management (merged from separate block) -->
            <?php if($has_tables) { ?>
            <li class="table-management-active-li"><a href="<?= $base_url; ?>operations/table_management"><i class="fa fa-table"></i> Table Management</a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class=" site-settings-active-li  change-pass-active-li dbbackup-active-li  tax-active-li currency-view-active-li  store_profile-active-li business-profile-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li gateways-active-li package-active-li subscription-active-li  subscription-list-active-li  sms-api-active-li smtp-active-li expiry_settings-active-li debt-reminder-active-li users-view-active-li users-active-li roles-list-active-li role-active-li attendance-shifts-active-li attendance-assign-active-li attendance-daily-active-li attendance-report-active-li sms-active-li sms-templates-list-active-li email-active-li email-templates-list-active-li warehouse-active-li warehouse-list-active-li store_list-active-li store-active-li subscribers-active-li subscribers_list-active-li country-active-li city-list-active-li country-list-active-li state-active-li state-list-active-li city-active-li approval-settings-active-li ninverify_usage-active-li ninverify_log-active-li system-updates-active-li manifest-active-li release-active-li subscription-license-active-li subscription-plans-active-li subscription-usage-active-li paystack_settings-active-li payment_modes_list-active-li payment_modes-active-li migrate-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!-- Branches (merged from separate block) -->
            <?php if(true){?>
            <?php if(($CI->permissions('warehouse_view') || $CI->permissions('warehouse_add')) && warehouse_module()) { ?>
            <?php
              try {
                $branch_label = mp_label('branch','Branches');
              } catch (Exception $e) {
                $branch_label = 'Branches';
              }
            ?>
            <?php if($CI->permissions('warehouse_add')) { ?>
            <li class="warehouse-active-li"><a href="<?php echo $base_url; ?>warehouse/add"><i class="fa fa-plus-square-o "></i> <span>New <?= $branch_label; ?></span></a></li>
            <?php } ?>
            ...
            <!-- Stores (merged from separate block) -->
            <?php if($CI->permissions('store_view') && store_module() && ($this->session->userdata('role_id') == 1 || is_store_admin())) { ?>
            <li class="store-active-li"><a href="<?php echo $base_url; ?>store/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('add_store'); ?></span></a></li>
            ...
            <!-- Users & Roles (merged from separate block) -->
            ...
            <li class="roles-list-active-li "><a href="<?php echo $base_url; ?>roles/view"><i class="fa fa-list "></i> <span><?= $this->lang->line('roles_list'); ?></span></a></li>
            <?php } ?>
            <?php } ?>

            <!-- Attendance (merged from separate block) -->
            ...
            <li class="attendance-report-active-li"><a href="<?php echo $base_url; ?>attendance/report"><i class="fa fa-bar-chart"></i> <span>Attendance Report</span></a></li>
            <?php } ?>
            <?php } ?>

            <!-- SMS & Messaging (merged from separate block) -->
            ...
            <!-- Data Migration -->
            <?php if($this->session->userdata('role_id') == 1 || is_store_admin()) { ?>
            <li class="migrate-active-li"><a href="<?php echo $base_url; ?>migrate"><i class="fa fa-random  "></i> <span>Data Migration</span></a></li>
            <?php } ?>
            ...
            <!-- Email Settings (Admin/Store Admin only) -->
            <?php if($CI->permissions('smtp_settings') && ($this->session->userdata('role_id') == 1 || is_store_admin())) { ?>
            ...
            <!-- Debt Reminder -->
            <?php if($CI->permissions('debt_reminder_view') || is_store_admin() || $this->session->userdata('role_id') == 1) { ?>
            ...
            <!-- Payment Gateways -->
            <?php if($CI->permissions('gateway_view') && ($this->session->userdata('role_id') == 1 || is_store_admin()) && store_module()) { ?>
            <li class="gateways-active-li"><a href="<?php echo $base_url; ?>gateways"><i class="fa fa- fa-credit-card  "></i> <span><?= $this->lang->line('payment_gateways'); ?></span></a></li>
            <?php } ?>

            <!-- Packages -->
            <?php if($CI->permissions('package_view') && ($this->session->userdata('role_id') == 1 || is_store_admin()) && store_module()) { ?>
            <li class="package-active-li  package-list-active-li"><a href="<?php echo $base_url; ?>package"><i class="fa fa-get-pocket  "></i> <span><?= $this->lang->line('package_list'); ?></span></a></li>
            <?php } ?>

            <!-- Subscriptions -->
            <?php if(true){?>
            <?php if($CI->permissions('subscription') && store_module()) { ?>
            <li class="subscription-active-li  subscription-list-active-li"><a href="<?php echo $base_url; ?>subscribers/list/<?= get_current_store_id() ?>"><i class="fa fa-calendar  "></i> <span><?= $this->lang->line('subscription'); ?></span></a></li>
            <?php } ?>
            ...
            <li class="payment_types_list-active-li payment_types-active-li"><a href="<?php echo $base_url; ?>payment_types/"><i class="fa fa-list "></i> <span><?= $this->lang->line('payment_types'); ?></span></a></li>
            <?php } ?>
            ...
            <!-- Permission Audit -->
            <?php if($this->session->userdata('role_id') == 1 || is_store_admin()) { ?>
            <li class="permission-audit-active-li"><a href="<?php echo $base_url; ?>permission_audit"><i class="fa fa-shield"></i> <span>Permission Audit</span></a></li>
            <?php } ?>

            <!-- Places (merged from separate block) -->
            <?php if($this->session->userdata('role_id') == 1 || is_store_admin()) { ?>
