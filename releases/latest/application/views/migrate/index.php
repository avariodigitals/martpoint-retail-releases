...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1><?=$page_title;?><small> Move old data into the fresh install</small></h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div id="step-upload" class="migrate-step <?= $step === 'upload' ? 'active' : ''; ?>">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">1. Upload the old backup</h3>
              </div>
              <div class="box-body">
          ...
          <div id="step-analyze" class="migrate-step <?= $step === 'analyze' ? 'active' : ''; ?>">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">2. Review what will be imported</h3>
              </div>
              <div class="box-body">
          ...
          <div id="step-import" class="migrate-step <?= $step === 'import' ? 'active' : ''; ?>">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">3. Import results</h3>
              </div>
              <div class="box-body">
          ...
          <div id="step-finish" class="migrate-step <?= $step === 'finish' ? 'active' : ''; ?>">
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">4. Finish</h3>
              </div>
              <div class="box-body">
