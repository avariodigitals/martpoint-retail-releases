  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 991px) {
      ...
      .mp-login-mobile-brand { display: flex; justify-content: center; margin-bottom: 20px; }
      .mp-login-mobile-brand img { max-height: 50px; }
      .mp-login-right {
        flex: 1 1 100%;
        width: 100%;
        min-width: 100%;
      ...
      .mp-login-powered { position: static; text-align: center; margin-top: 16px; right: auto; bottom: auto; }
      .mp-demo-box { max-width: 100%; }
      .mp-demo-box .table { font-size: 11px; }
      .mp-demo-box .table td { padding: 8px 8px; word-break: break-word; }
    }
    @media (max-width: 480px) {
      .mp-login-right { padding: 16px 12px; }
      .mp-login-card { padding: 20px 16px; border-radius: 12px; }
      .mp-login-card-header h2 { font-size: 20px; }
      .mp-login-card-header p { font-size: 13px; }
      .mp-login-form .form-control { height: 44px; font-size: 16px; }
      .mp-login-form .btn-signin { height: 44px; font-size: 14px; }
      .mp-login-form .btn-google { height: 44px; font-size: 13px; }
      .mp-login-options { flex-direction: column; align-items: flex-start; gap: 10px; }
      .mp-login-options .forgot { align-self: flex-end; }
      .mp-demo-box .table td { font-size: 10px; padding: 6px 6px; }
      .mp-demo-box .btn-info { font-size: 10px; padding: 4px 8px; }
    }
  </style>
</head>
<body>
