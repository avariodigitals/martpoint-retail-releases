                           ...
                           <div class="box-body">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-10">
                                    <div class="btn-group" role="group" aria-label="Date range">
                                       <button type="button" class="btn btn-default btn-range" data-from="<?= show_date(date('Y-m-d')); ?>" data-to="<?= show_date(date('Y-m-d')); ?>">Today</button>
                                       <button type="button" class="btn btn-default btn-range" data-from="<?= show_date(date('Y-m-d', strtotime('-1 day'))); ?>" data-to="<?= show_date(date('Y-m-d', strtotime('-1 day'))); ?>">Yesterday</button>
                                       <button type="button" class="btn btn-default btn-range" data-from="<?= show_date(date('Y-m-d', strtotime('-7 days'))); ?>" data-to="<?= show_date(date('Y-m-d')); ?>">Last 7 Days</button>
                                       <button type="button" class="btn btn-default btn-range" data-from="<?= show_date(date('Y-m-d', strtotime('-30 days'))); ?>" data-to="<?= show_date(date('Y-m-d')); ?>">Last 30 Days</button>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-2">
                                    <span class="text-muted"><small>Stock level is as of the To Date</small></span>
                                 </div>
                              </div>
                           </div>
                           <!-- /.box-body -->
