    ...
    <section class="screen">
      ...
      <div class="card">
        ...
        ?>
          <div class="payment-card">
            ...
            <div class="payment-meta"><?= htmlspecialchars(payment_mode_label($res3p->payment_type)); ?> &middot; <?= htmlspecialchars(get_account_name($res3p->account_id)); ?><?php if($res3p->cheque_number): ?> &middot; Cheque: <?= htmlspecialchars($res3p->cheque_number); ?><?php endif; ?></div>
          </div>
        <?php endforeach; ?>
      ...
      <div class="actions">
        ...
        <?php if($CI->permissions('sales_return_add')): ?>
          <a href="<?= base_url('mobile/sales_return_form/' . $sales_id); ?>" class="btn-return" style="grid-column: span 2;"><i class="fa fa-undo"></i> Sales Return</a>
        <?php endif; ?>
      </div>
      <?php endif; ?>
