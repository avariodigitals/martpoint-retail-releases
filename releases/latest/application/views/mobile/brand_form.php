...
<head>
  ...
  <title><?= $SITE_TITLE ?? 'MartPoint'; ?> — Add Brand</title>
...
<body>
  <div id='app'>
    <section class='screen'>
      ...
      <form id='brand-form' action='<?= base_url('mobile/save_brand'); ?>' method='post'>
        <input type='hidden' name='<?= $this->security->get_csrf_token_name(); ?>' value='<?= $this->security->get_csrf_hash(); ?>'>

        <div class='card'>
          <div class='form-group'>
            <label>Brand Name <span class='req'>*</span></label>
            <input type='text' name='brand' id='brand' value='<?= htmlspecialchars($brand_name); ?>' placeholder='e.g. Nestlé, Nike' required>
          </div>
          <div class='form-group'>
        ...
        <button type='submit' class='btn btn-primary' id='btn-save'>Save Brand</button>
  ...
  <script>
    ...
    form.addEventListener('submit', function(e){
      ...
      fetch('<?= base_url('mobile/save_brand'); ?>', {
        method: 'POST',
        body: formData
      })
