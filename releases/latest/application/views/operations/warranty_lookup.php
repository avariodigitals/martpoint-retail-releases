...
<div class="content-wrapper">
  <section class="content-header">
    <h1><?= $page_title; ?><small>Validate warranty by serial, IMEI, invoice, customer, or product</small></h1>
          ...
          <div class="box-body">
            <form method="get" class="form-inline" style="margin-bottom:20px;">
              <div class="form-group">
                <label>Search:</label>
                <input type="text" name="search" class="form-control" placeholder="Serial, IMEI, invoice, customer, or product name" value="<?= htmlspecialchars($search ?? ''); ?>" style="width:300px;">
              </div>
