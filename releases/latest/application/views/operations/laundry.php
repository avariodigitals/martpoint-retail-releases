            ...
            <div class="row">
              ...
              <div class="col-md-2 col-sm-4 col-xs-6" style="margin-bottom:8px;">
                <div style="background:#f4f4f4;padding:8px;border-radius:3px;text-align:center; border-left: 3px solid #6c757d;">
                  ...
                  <div style="font-size:11px;color:#999;margin-top:3px;"><i class="fa fa-check-square-o" style="color:#28a745;"></i> <?= is_valid_date($sv->updated_at) ? date('H:i', strtotime($sv->updated_at)) : 'Just now'; ?></div>
                </div>
              </div>
              <?php endforeach; ?>
            </div>
