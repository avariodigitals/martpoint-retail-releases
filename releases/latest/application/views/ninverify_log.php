<?php
/* NIN/BVN verification log page — content-only view for mp_layout */
?>
...
<div class="mp-page-head"><h1 class="mp-page-title"><?= $page_title; ?> <small>Usage & Billing Transparency</small></h1></div>
...
<script>
$(".ninverify_log-active-li").addClass("active");
$(".ninverify_log-active-li").closest(".mp-nav-group").addClass("open");
</script>
