...
<title><?= htmlspecialchars($page_title ?? 'Sales Invoice'); ?> - A4</title>
<meta property="og:type" content="website">
<meta property="og:site_name" content="<?= htmlspecialchars($og_site_name ?? 'MartPoint'); ?>">
<meta property="og:title" content="<?= htmlspecialchars($og_title ?? ($page_title ?? 'Sales Invoice')); ?>">
...
<meta name="twitter:title" content="<?= htmlspecialchars($og_title ?? ($page_title ?? 'Sales Invoice')); ?>">
...
.totals-inner .value { text-align: right; font-weight: bold; width: 100%; min-width: 120px; white-space: nowrap; }
...
$sales_invoice_footer_text = mp_get_store_receipt_setting(get_current_store_id(), 'sales_invoice_footer_text', '');
$invoice_terms = mp_get_store_receipt_setting(get_current_store_id(), 'invoice_terms', '');

$q3 = $this->db->query("SELECT b.coupon_id,b.coupon_amt,b.due_date,b.customer_previous_due,b.customer_total_due,b.customer_id,COALESCE(a.customer_name,'Walk-in Customer') as customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,a.shippingaddress_id,
...
$q_payments = $this->db->query("SELECT * FROM db_salespayments WHERE sales_id='$sales_id' ORDER BY id");
  ...
  <tr>
    ...
    <td class="meta" width="140">
      <table class="meta-table">
        <tr><td class="meta-label"><?= $this->lang->line('invoice'); ?></td></tr>
        <tr><td class="meta-value"><?= $sales_code; ?></td></tr>
        <tr><td class="meta-label" style="padding-top: 8px;"><?= $this->lang->line('date'); ?></td></tr>
        <tr><td class="meta-sm"><?= show_date($sales_date); ?></td></tr>
        <?php if(!empty($due_date)): ?>
        <tr><td class="meta-label" style="padding-top: 8px;"><?= $this->lang->line('due_date'); ?></td></tr>
        <tr><td class="meta-sm"><?= show_date($due_date); ?></td></tr>
        <?php endif; ?>
      </table>
    </td>
  </tr>
...
<table class="items">
  <thead>
    <tr>
      ...
      <th class="num"><?= $this->lang->line('rate'); ?></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="qty"><?= format_qty($res2->sales_qty); ?></td>
...
<table class="totals">
  <tr>
    <td valign="top" style="padding-right: 10px; font-size: 9pt; color: #374151;">
      <?php if(!empty($bank_details)): ?>
        <strong><?= $this->lang->line('bank_details'); ?>:</strong><br>
        <?= nl2br($bank_details); ?>
      <?php endif; ?>
    </td>
    <td align="right" valign="top" style="white-space: nowrap; text-align: right; width: 50%; vertical-align: top;">
      <table class="totals-inner" align="right">
        ...
        <tr><td class="label"><?= $this->lang->line('couponDiscount'); ?> <?= ($coupon_type == 'Percentage') ? $coupon_value . '%' : '[Fixed]'; ?></td><td class="value"><?= $CI->currency($coupon_amt); ?></td></tr>
        <?php endif; ?>
...
<?php if(!empty(trim($sales_note)) && trim($sales_note) !== 'Created via MartPoint Assist'): ?>
<table class="note-table" style="margin-top: 10px;">
  <tr><td><strong><?= $this->lang->line('note'); ?>:</strong> <?= nl2br($sales_note); ?></td></tr>
</table>
<?php endif; ?>
...
<table class="footer-table">
  <tr><td>
    <?= !empty($sales_invoice_footer_text) ? $sales_invoice_footer_text : $this->lang->line('thank_you_for_your_business'); ?><br>
