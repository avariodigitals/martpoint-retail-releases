...
<div class="mp-section">
  <div class="mp-page-head">
    <div>
      <h2><?= $page_title; ?></h2>
      <div class="mp-page-sub"><?= htmlspecialchars($store_name); ?> &mdash; Import categories from a CSV file</div>
    </div>
      ...
      <div class="mp-card-body">
        <div class="mp-form-grid">
          <div class="mp-form-group full">
            <label><?= $this->lang->line('import_categories'); ?> <span class="text-danger">*</span></label>
            ...
            <p class="mp-form-hint">File must be in CSV format. <a href="<?= base_url('import/download/categories'); ?>" style="color:var(--mp-primary);font-weight:600;">Download example format</a></p>
  ...
  <div class="mp-card-form">
    ...
    <div class="mp-card-body" style="padding:0;">
      <table class="mp-tbl" id="report-data">
        ...
        <tbody id="tbodyid">
          <?php $i=1; ?>
          <tr><td><?= $i++; ?></td><td><?= $this->lang->line('category_name'); ?></td><td><span class="mp-pill ok"><?= $this->lang->line('required'); ?></span></td><td>Existing category names are skipped</td></tr>
...
<script type="text/javascript">
  $("#import").on("click", function(e) {
    ...
    function doImportCategories() {
      ...
      $.ajax({
        type: 'POST',
        url: base_url + 'import/import_categories_csv',
        data: data,
        cache: false,
        contentType: false,
        processData: false,
    ...
    if (typeof swal === 'undefined') {
      ...
      swal({
        title: "Are you sure?",
        text: "This will import categories from the selected CSV file.",
        icon: "warning",
        buttons: true,
        dangerMode: true
      }).then(function(willImport) {
        if (willImport) doImportCategories();
      });
    }
  });
</script>
