        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url('import/download/customers');?>"><button type="button" class="btn btn-info pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-bordered table-hover " id="report-data" >
                ...
                <tr>
                  ...
                  <th style=""><?= $this->lang->line('details'); ?></th>
                </tr>
                </thead>
                <tbody id="tbodyid">
                  <?php $i=1; ?>
                  ...
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('credit_limit'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td>[ <b>-1</b> for No Limit]</td>
                  </tr>
                  <tr>
                    <td><?=$i++;?></td>
                  ...
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('location_link'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td>Map Link location or <br> URL/Web address link</td>
                  </tr>
                  
                  <!-- SHIPPING ADDRESS DETAILS -->
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('shipping_country_name'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('shipping_state_name'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('shipping_postcode'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('shipping_address'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('shipping_location_link'); ?></td>
                    <td style="font-style: italic;"><span class="label label-default"><?= $this->lang->line('optional'); ?></td>
                    <td>Map Link location or <br> URL/Web address link</td>
                  </tr>
