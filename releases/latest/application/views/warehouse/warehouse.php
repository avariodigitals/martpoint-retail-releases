         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo $base_url; ?>warehouse">Branch List</a></li>
                        ...
                        <form class="form-horizontal" id="warehouse-form" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 <label for="warehouse_name" class="col-sm-2 control-label">Branch Name<label class="text-danger">*</label></label>
                                 <div class="col-sm-4">
