                     ...
                     <div class="box box-primary">
                        <div class="box-header with-border">
                           ...
                           <?php
                             ...
                             $at_limit = ($branch_limit > 0 && $branch_used >= $branch_limit);
                           ?>
                           <?php if($CI->permissions('warehouse_add') && !$at_limit) { ?>
                            <div class="box-tools">
                            ...
                            <?php } elseif($at_limit) { ?>
                            <div class="box-tools">
                              <span class="label label-warning" style="font-size: 12px; padding: 6px 10px;"><i class="fa fa-exclamation-triangle"></i> Branch limit reached (<?=$branch_used;?>/<?=$branch_limit;?>)</span>
                            </div>
                            <?php } ?>
                        </div>
         ...
         function delete_warehouse(id)
         {
          var base_url=$("#base_url").val();
            if(typeof swal === 'undefined'){
              ...
              doDeleteWarehouse(id, base_url);
              return;
            }
            swal({
              title: "Delete Record?",
              text: "Do you want to delete this warehouse record?",
              icon: "warning",
              buttons: true,
              dangerMode: true
            }).then(function(willDelete){
              if(willDelete) doDeleteWarehouse(id, base_url);
            });
         }
         function doDeleteWarehouse(id, base_url){
