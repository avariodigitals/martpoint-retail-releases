<?php
/* Manifest Generator — content-only view for mp_layout */
?>
<?php $this->load->view('admin/desktop/_styles'); ?>
<?php include "comman/code_flashdata.php"; ?>

<div class="mp-page-head">
  <h1 class="mp-page-title">Release Manifest Generator</h1>
</div>
...
<script>$('.manifest-active-li').addClass("active");$('.manifest-active-li').closest(".mp-nav-group").addClass("open");</script>
