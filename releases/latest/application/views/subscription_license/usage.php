<?php
/* License usage stats page — content-only view for mp_layout */
?>
...
<div class="mp-page-head"><h1 class="mp-page-title">License Usage</h1></div>
...
<script>
$(".subscription-usage-active-li").addClass("active");
$(".subscription-usage-active-li").closest(".mp-nav-group").addClass("open");
</script>
