<?php
/* License Management dashboard — content-only view for mp_layout */
?>
...
<div class="mp-page-head"><h1 class="mp-page-title">Subscription Control</h1></div>
...
<div class="row">
    ...
    <div class="box box-primary">
      ...
      <form id="generate-form">
        ...
        <div class="box-footer">
          <button type="button" class="mp-btn-secondary" onclick="showGenerateOTP()">
  ...
  <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Email Reminders</span>
                <span class="info-box-number"><?= $reminder_count ?? 0; ?> sent</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        <a href="<?=base_url('subscription_license/activate_form');?>" class="mp-btn-primary">
        ...
        <button type="button" class="mp-btn-secondary" data-toggle="modal" data-target="#suspendModal">
