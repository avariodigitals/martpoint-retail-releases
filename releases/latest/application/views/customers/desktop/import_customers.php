...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">Import customers from a CSV file</div>
  </div>
</div>
...
<div class="mp-card box" style="margin-top:24px;">
  <div class="mp-card-head">
    ...
    <a href="<?= base_url('import/download/customers'); ?>"><button type="button" class="mp-qa-btn blue" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button></a>
  </div>
  <div class="mp-card-body" style="padding:0;">
    <table class="table mp-static-table" id="report-data">
      ...
      <tbody id="tbodyid">
        <?php $i=1; ?>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('customer_name'); ?></td><td><span class="mp-pill success"><?= $this->lang->line('required'); ?></span></td><td></td></tr>
        ...
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('previous_due'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td></td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('credit_limit'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td>[ <b>-1</b> for No Limit]</td></tr>
        ...
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('location_link'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td>Map Link location or <br> URL/Web address link</td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('shipping_country_name'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td></td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('shipping_state_name'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td></td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('shipping_postcode'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td></td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('shipping_address'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td></td></tr>
        <tr><td><?=$i++;?></td><td><?= $this->lang->line('shipping_location_link'); ?></td><td><span class="mp-pill muted"><?= $this->lang->line('optional'); ?></span></td><td>Map Link location or <br> URL/Web address link</td></tr>
      </tbody>
    </table>
  </div>
</div>
...
<script type="text/javascript">
  $("#import").on("click",function(e) {
    ...
    if(typeof swal === 'undefined'){
      ...
      swal({
        title: "Are you sure?",
        text: "This will import customers from the selected CSV file.",
        icon: "warning",
        buttons: true,
        dangerMode: true
      }).then(function(willImport){
        if(willImport) doImportCustomers();
      });
    }
  });
</script>
