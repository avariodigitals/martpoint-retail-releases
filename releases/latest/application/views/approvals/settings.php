<?php
/* Approvals settings form — content-only view for mp_layout */
?>
...
<form id="approvalSettingsForm">
  ...
  <div class="text-center" style="margin-bottom:30px;">
    <button type="button" id="saveBtn" class="mp-btn-primary"><i class="fa fa-save"></i> Save Settings</button>
...
<script>
$(".approvals-settings-active-li").addClass("active");
$(".approvals-settings-active-li").closest(".mp-nav-group").addClass("open");
</script>
