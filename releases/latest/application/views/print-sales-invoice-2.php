          ...
          <table width="100%">
            ...
            <tr>
              ...
              <th colspan="6" style="text-align: right;">
                <img src="<?= base_url($store_logo);?>" width='auto' height='150px'>
              </th>
...
<tbody style="border: 1px solid;">
 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td style='text-align: right;border-right: 1px solid;border-top: 1px solid;'>".store_number_format($res2->total_cost)."</td>";
                  echo "</tr>";  
...
<tfoot>
  ...
  <tr>
    <td colspan="10" style="text-align: right;"><b><?= $this->lang->line('round_off'); ?></b></td>
    <td colspan="1" style="text-align: right;" ><b><?php echo store_number_format($round_off); ?></b></td>
  </tr>
  
  <?php if($shipping_fee > 0){ ?>
  <tr>
    <td colspan="10" style="text-align: right;"><b>Shipping<?= $shipping_label!=='' ? ' ('.htmlspecialchars($shipping_label).')' : ''; ?></b></td>
    <td colspan="1" style="text-align: right;" ><b><?php echo store_number_format($shipping_fee); ?></b></td>
  </tr>
  <?php } ?>
  <tr>
