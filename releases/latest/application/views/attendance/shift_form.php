<?php
/* Shift add/edit form — content-only view for mp_layout */
?>
<?php $this->load->view('admin/desktop/_styles'); ?>
<div class="mp-page-head">
  <h1 class="mp-page-title"><?= $shift ? 'Edit Shift' : 'New Shift' ?></h1>
</div>
<div class="mp-card">
  <div class="mp-card-body">
    <form id="shiftForm">
      ...
      <button type="submit" class="mp-btn-primary"><i class="fa fa-save"></i> Save Shift</button>
