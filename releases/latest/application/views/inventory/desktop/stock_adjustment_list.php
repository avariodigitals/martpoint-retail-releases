...
<div class="mp-page-head">
  <div>
    ...
    <div class="mp-page-sub">View and manage stock adjustments</div>
  </div>
  <?php if($CI->permissions('stock_adjustment_add')): ?>
  <a href="<?= base_url('stock_adjustment/add'); ?>" class="mp-qa-btn green">
      ...
      <table id="example2" class="table mp-dt-table" width="100%">
        <thead>
          <tr>
            ...
            <th><?= $this->lang->line('adjustment_date') ?: 'Adjustment Date'; ?></th>
            <th><?= $this->lang->line('reference_no') ?: 'Reference No'; ?></th>
...
<script type="text/javascript">
  function load_datatable(){
    var table = $('#example2').DataTable({
      ...
      "ajax": {
        "url": "<?= site_url('stock_adjustment/ajax_list'); ?>",
        "type": "POST",
        "data": {
