...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $theme_link; ?>dist/css/martpoint-reskin.css?v=6">
  <?php 
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?= form_open(base_url('login/verify'), array('method'=>'POST', 'id'=>'registration_form'));?>
      <div class="div1">
        ...
        <div class="row">
          <div class="col-xs-6 col-xs-offset-6">
            <button type="button" class="btn btn-primary btn-block btn-flat pull-right" onclick="show_second()"><?= $this->lang->line('next'); ?></button>
          </div>
        </div>
      </div> <!-- Div 1 end -->
      ...
      <div class="div2 hide">
        ...
        <div class="row">
          <div class="col-xs-6">
            <button type="button" class="btn btn-default btn-block btn-flat pull-right" onclick="show_first()"><?= $this->lang->line('previous'); ?></button>
          </div>
          <div class="col-xs-6">
            <button type="button" class="btn btn-primary btn-block btn-flat pull-right" onclick="show_third()"><?= $this->lang->line('next'); ?></button>
          </div>
        </div>
      </div> <!-- Div 2 end -->
      <div class="div3 hide">
        ...
        <div class="row">
          <div class="col-xs-6">
            <button type="button" class="btn btn-default btn-block btn-flat pull-right" onclick="show_second(false)"><?= $this->lang->line('previous'); ?></button>
          </div>
          <div class="col-xs-6">
            <button type="button" class="btn btn-primary btn-block btn-flat pull-right submit_btn" onclick="submit_form()"><?= $this->lang->line('submit'); ?></button>
          </div>
        </div>
      </div> <!-- Div 3 end -->
      ...
      <div class="row">        
        <div class="col-xs-6 text-right pull-right"><br>
          <a href="<?=base_url('login')?>"><?= $this->lang->line('i_have_account'); ?></a>
        </div>
      </div>
 ...
 <?php if(demo_app()){ ?>
  <div class="box-body">
    <label><?= $this->lang->line('click_to_start_session'); ?></label>
    <div class="row">
     <div class="col-md-12">
       <table class="table table-bordered table-condensed text-center">         
            <tr>
              <td>mng@martpoint.com.ng</td>
              <td>Qualcker%6</td>
    ...
    <i><i class="fa fa-fw fa-info-circle text-warning"></i><?= $this->lang->line('some_features_disabled'); ?></i>
  </div>
<?php } ?>
...
<script type="text/javascript">
  ...
  function validate_first(){
    ...
    if(!get_name_value('mobile')){
      $(".mobile_msg").removeClass('hide').text("Required Field!");
      flag=false;
    }
