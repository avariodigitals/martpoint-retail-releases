...
function delete_stock(q_id)
{
  ...
  if(typeof swal === 'undefined'){
    ...
    doDeleteStock(q_id, base_url);
    return;
  }
  swal({
    title: "Delete Record?",
    text: "Do you want to delete this stock record?",
    icon: "warning",
    buttons: true,
    dangerMode: true
  }).then(function(willDelete){
    if(willDelete) doDeleteStock(q_id, base_url);
  });
}
...
function multi_delete(){
  var base_url=$("#base_url").val();
    ...
    if(typeof swal === 'undefined'){
      ...
      swal({
        title: "Are you sure?",
        text: "This will delete the selected records.",
        icon: "warning",
        buttons: true,
        dangerMode: true
      }).then(function(willDelete){
        if(willDelete) doMultiDelete();
      });
    }
