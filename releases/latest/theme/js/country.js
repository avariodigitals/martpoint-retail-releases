...
{
	var base_url=$("#base_url").val();
	$.post(base_url+"country/update_status",{id:id,status:status},function(result){
		if(result=="success")
				{
...
function delete_country(q_id)
{
  ...
  if(typeof swal === 'undefined'){
    ...
    doDeleteCountry(q_id, base_url);
    return;
  }
  swal({
    title: "Delete Record?",
    text: "Do you want to delete this country record?",
    icon: "warning",
    buttons: true,
    dangerMode: true
  }).then(function(willDelete){
    if(willDelete) doDeleteCountry(q_id, base_url);
  });
}
function doDeleteCountry(q_id, base_url){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
   $.post(base_url+"country/delete_country",{q_id:q_id},function(result){
	   if(result=="success")
				{
