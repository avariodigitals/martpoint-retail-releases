...
function delete_gateways(q_id)
{
  ...
  if(typeof swal === 'undefined'){
    ...
    doDeleteGateways(q_id, base_url);
    return;
  }
  swal({
    title: "Delete Record?",
    text: "Do you want to delete this gateway record?",
    icon: "warning",
    buttons: true,
    dangerMode: true
  }).then(function(willDelete){
    if(willDelete) doDeleteGateways(q_id, base_url);
  });
}
function doDeleteGateways(q_id, base_url){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
