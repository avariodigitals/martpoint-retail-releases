   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    var this_id=this.id;
        ...
        $("#"+this_id).attr('disabled',true);  //Enable Save or Update button
				$.ajax({
				type: 'POST',
				url: base_url+'sales_return/sales_save_and_update?command='+this_id+'&rowcount='+rowcount+'&tot_subtotal_amt='+tot_subtotal_amt+'&tot_discount_to_all_amt='+tot_discount_to_all_amt+'&tot_round_off_amt='+tot_round_off_amt+'&tot_total_amt='+tot_total_amt+"&other_charges_amt="+other_charges_amt+"&coupon_discount_amt="+coupon_discount_amt,
				data: data,
				cache: false,
				contentType: false,
				processData: false,
...
function get_coupon_details(){
  ...
  if(coupon_code!=''){
    ...
    $.post(base_url+'customer_coupon/get_coupon_details', {invoice_type: 'return', coupon_code: coupon_code,customer_id:customer_id}, function(data, textStatus, xhr) {
