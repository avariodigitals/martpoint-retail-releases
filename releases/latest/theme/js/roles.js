...
{
	var base_url=$("#base_url").val();
	$.post(base_url+"roles/update_status",{id:id,status:status},function(result){
		if(result=="success")
				{
...
function delete_roles(q_id)
{
   ...
   swal({
     ...
     if(willDelete){
       $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
       $.post(base_url+"roles/delete_roles",{q_id:q_id},function(result){
         if(result=="success")
         {
...
function multi_delete(){
   ...
   swal({
     ...
     if(willDelete){
       ...
       $.ajax({
         type: 'POST',
         url: base_url+'roles/multi_delete',
         data: data,
         cache: false,
         contentType: false,
         processData: false,
