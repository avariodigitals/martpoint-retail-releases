...
class Database {
	...
	function create_tables($data){
		// Purchase code validation removed — license is verified after installation
		$con1=mysqli_connect($data['hostname'],$data['username'],$data['password'],$data['database']);

		$update_sql = file_get_contents("../install/includes/db.txt",true);

		$q1=mysqli_multi_query($con1,$update_sql);
		...
		if($q1){
			...
			echo "<div class='container'>
                <div class='col-md-4 col-md-offset-4'>
        					...
        					Failed To Update! Check if database already has latest schema.
        					</p>
        		</div>
        		</div>";
        		exit;
	...
	function support(){
        ...
        <div class='col-md-4 col-md-offset-4'>
					...
					Email: support@avariodigitals.com
					</p>
		</div>
		</div>
		<br>
