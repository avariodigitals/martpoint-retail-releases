...
CREATE TABLE IF NOT EXISTS `db_subscription_plans` (
  ...
  `sku_limit` int(11) NOT NULL DEFAULT 10000,
  `online_product_limit` int(11) NOT NULL DEFAULT 500,
...
INSERT INTO `db_subscription_plans`
  (`plan_name`, `plan_code`, `description`, `branch_limit`, `user_limit`, `product_limit`, `sku_limit`, `online_product_limit`, `service_limit`, `media_storage_limit_mb`, `storefront_limit`, `custom_domain_limit`, `is_active`, `display_order`, `created_date`, `created_time`, `created_by`)
VALUES
...
CREATE TABLE IF NOT EXISTS `db_subscription_license` (
  ...
  `sku_limit` int(11) DEFAULT 10000,
  `online_product_limit` int(11) DEFAULT 500,
  ...
  `override_sku_limit` int(11) DEFAULT NULL,
  `override_online_product_limit` int(11) DEFAULT NULL,
...
-- ============================================================================
-- Industry Modules Schema (kitchen/production/butchery/vehicle) - v4.0.9.12
-- ============================================================================
